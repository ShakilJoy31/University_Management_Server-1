...
import { academicSemesterSearchAbleFields, academicSemesterTitleCodeMapper } from "./academicSemester.constants";
...
// Function is for Creating a new semester.
...
// Function is for getting all the semester.
const getAllSemesters = async (filters:IAcademicSemesterFilters,paginationOption: IPaginationOptions):Promise<IGenericResponse<IAcademicSemester[]>> =>{
