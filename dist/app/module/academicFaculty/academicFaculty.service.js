...
const getAllFaculty = (filters, paginationOptions) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result = yield academicFaculty_model_1.AcademicFaculty.find(whrereConditions).sort(sortConditions).skip(skip).limit(limit);
...
const getParticularFaculty = (id) => __awaiter(void 0, void 0, void 0, function* () {
